package ua.blackwind.limbushelper.ui.theme
...
val wrath = Color(0xFFB71C1C)
val lust = Color(0xFFE65100)
val sloth = Color(0xFFCDBD13)
...
val addToPartyIconTint = LightGolden
val removeFromPartyIconColor = LightGreen